                ...
                echo"                    
                    <div class='col-6 col-md-4 user-detail'>
                        ...
                        <div class='col-sm-7 user-name-buttons'> 
                             ...
                             <div class=' row name'>
                                  <a href=href='../home.php?id={$row['userId']}'><p style='margin:10px 10px;'>{$row['firstName']}</p></a>
                             </div>
...
{
    global $conn,$me;
    $query="select player2_id from battle where player1_id='$me' && player2_post is null && status = '1'";
            ...
            {     
                ...
                echo"
                    ...
                    <div class='col-6 col-md-4 user-detail'>
                            ...
                            <img src='../dp/{$rimg}' style='width:100px'> 
                               <div class='user-pic' style='display: flex;margin-left: 35px;'> 
                               <img src='../dp/{$rimg}' style='height: 30px;width: 30px;'> 
                               <a href='../home.php?id={$row['player2_id']}'>
                                  <p class='name-tilte' style='font-size: 12px;text-transform: capitalize;margin: 6px;'>{$receiverNameDp['firstName']}</p>
                                  </a>
                               </div>
...
{
    global $conn,$me;
    $query="select * from battle where player2_id='$me' && player2_post is NULL && status = '1'";
    $requestedUser=mysqli_query($conn,$query);
    if($requestedUser)
        {
        if(mysqli_num_rows($requestedUser) >= 1)
        {  
            while($row=mysqli_fetch_array($requestedUser))
            {
                ...
                echo"
                     ...
                     <div class='col-6 col-md-4 user-detail'>
                            <img src='data:image/jpeg;base64, $imgData' style='width: 100px;margin-bottom: 10px;'/>
                            
                           <div class='user-pic' style='display: flex;margin-left: 35px;'> 
                              <img src='data:image/jpeg;base64, $imgData' style='width:30px;height:30px;'/>
                    ...
                    if($friend['userId']==$battle['senderId'] || $friend['userId']==$battle['receiverId'])
                      ...
                      echo"
                        ...
                        <div class='col-6 col-md-4 user-detail'>
                              ...
                              <div class=' user-name-buttons'> 
                                  <div class='row name'><a href='../home.php?id={$row['userId']}'>
                    ...
                    // {
                      echo"
                          <div class='col-6 col-md-4 user-detail'>
                                ...
                                <div class='user-name-buttons'> 
                                    <div class='name'><a href='../home.php?id={friend['userId']}'>
...
function battle()
{
    global $conn,$me;
    $type='';
    $query ="SELECT * FROM `battle` WHERE (`player1_id` = $me or `player2_id`= $me) && `player1_post` is not null && `player2_post` is not null && `status` = '1'";
     ...
     {  
           ...
           {       
                  ...
                  if($row['player1_id']==$me)
                  {
                     $query="select userId,firstName ,dp from user where userId={$row['player2_id']}";
                      ...
                      $friend=mysqli_fetch_array($nameDp);
                        $type= 'p2';
                      if($row['player1_post']=='')
                        $but1 = "<a href='../add_battle.php?bid=".$row['battle_id']."&&pid=".$friend['userId']."&&type=".$type."'><button data-id='{$friend['userId']}' data-name='{$friend['firstName']}' class='battle-btn btn-sm btn-success' style='width:fit-content;'>Battle not started</button></a>";
                      else
                        $but1 = "<a href='delete.php?pid1=".$friend['userId']."&&type=".$type."&&pid2=".$me."'><button data-id='{$friend['userId']}' data-name='{$friend['firstName']}' class='battle-btn btn-sm btn-danger' style='width:fit-content;'>Delete Battle</button></a>";
                       ...
                       echo"
                        <div class='col-6 col-md-4 user-detail'>
                            ...
                            <div class=' user-name-buttons'> 
                                <div class='row name'><a href='../home.php?id={friend['userId']}'>
                 ...
                 else
                 {
                    ...
                    $type= 'p1';
                    if($row['player2_post']=='')
                    $but2 = "<a href='../add_battle.php?bid=".$row['battle_id']."&&pid=".$friend['userId']."&&type=".$type."'><button data-id='{$friend['userId']}' data-name='{$friend['firstName']}' class='upload-btn btn-sm btn-success' style='width:fit-content;'>Battle Not Started</button></a>";
                    else
                    $but2 = "<a href='delete.php?pid1=".$friend['userId']."&&type=".$type."&&pid2=".$me."'><button data-id='{$friend['userId']}' data-name='{$friend['firstName']}' class=' btn-sm btn-danger' style='width:fit-content;'>Delete Battle</button></a>";
                    //  $but2 = "<a href='delete.php?pid1=".$friend['userId']."&&type=".$type."&&pid2=".$me."'><button data-id='{$friend['userId']}' data-name='{$friend['firstName']}' class=' btn-sm btn-danger' style='width:fit-content;'>Battle is Live</button></a>";
