...
"><i class="fa fa-times"></i></button></span>
    ...
    <button type="button" data-pid='<?php echo $pid ?>' class="all-likes w3-button w3-theme-d1 w3-margin-bottom btn" style="color: #8d8d8d!important;
    background-color: #f1f1f1!important;
    border-radius: 20px;font-size: 14px;">
        <!-- <i class="fa fa-thumbs-up"></i>  -->
        <?= mysqli_num_rows(fetchResult('likes','postId='.$list['postId'].''))+ mysqli_num_rows(fetchResult('dislikes','postId='.$list['postId'].'')) ?> Votes
    </button>
    ...
    border-radius: 20px;font-size: 14px;">
        ...
        <?= mysqli_num_rows(fetchResult('comments','postId='.$list['postId'].'')) ?> Comments
    </button>
    ...
    <div>
        ...
        <button type="button" data-pid='<?php echo $pid ?>' class=" insert-comment w3-button w3-theme-d2 w3-margin-bottom btn" style="
