...
function getPost($from, $count)
{
                ...
                while ($list = mysqli_fetch_array($postList)) {
                    ...
                    if ($list['type'] == "text") { ?>
                        ...
                        <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                            <img src="dp/<?php echo $user['dp'] ?>" alt="Avatar3" class="w3-left w3-circle w3-margin-right" style="border-radius:50%;width:100px;">
                            ...
                            <!-- ajit aaded -->
                            <button type="button" data-pid="<?php echo $list['postId'] ?>" class="dislike-btn w3-button w3-theme-d1 w3-margin-bottom">
                    ...
                    <?php
                        ...
                        <div class="w3-container w3-card w3-white w3-round w3-margin">
                            <img src="dp/<?php echo $user['dp'] ?>" alt="Avatar4" class="w3-left w3-circle w3-margin-right" style="width:37px;border-radius:50%;margin-bottom:8px;margin-left:12px!important;">
    ...
    background: #fff;"><i style="color:<?php echo $color ?>" id="<?php echo $list['postId'] ?>" class="fa fa-heart-o heart-graph text-danger graph-heart"></i> &nbsp;<span id="like<?php echo $list['postId'] ?>" style="color:#000;">
    ...
    background: #fff;"><i style="color:<?php echo $color ?>" id="<?php echo $list['postId'] ?>" class="fa fa-heart heart-graph text-danger graph-heart"></i> &nbsp;<span id="dislike<?php echo $list['postId'] ?>" style="color:#000;">
    ...
    if ($total > 0) {
        while ($list = mysqli_fetch_array($postList)) {
            ...
            if ($list['type'] == "text") { ?>
                <!--                  html area-->
                <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                    <img src="dp/<?php echo $user['dp'] ?>" alt="Avatar1" class="w3-left w3-circle w3-margin-right" style="border-radius:50%;width:100px;">
                    <span class="w3-right w3-opacity"><?php echo $postDate ?></span>
                    <a href="./profile/profile.php?id=<?php echo $list['userId'] ?>">
                        <h4><?php echo $user['firstName'] ?></h4><br>
                    </a>
            ...
            <?php
                ...
                <!--                html area  -->
                <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                    <img src="dp/<?php echo $user['dp'] ?>" alt="Avatar2" class="w3-left w3-circle w3-margin-right" style="border-radius:50%;width:100px;">
                    <span class="w3-right w3-opacity"><?php echo $postDate ?></span>
                    <a href="./profile/profile.php?id=<?php echo $list['userId'] ?>">
                        <h4><?php echo  $user['firstName'] ?></h4><br>
                    </a>
